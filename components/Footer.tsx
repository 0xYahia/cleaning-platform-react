...
export function Footer() {
  ...
  return (
    <footer className="bg-white border-t border-surface-variant/50 pt-xl pb-10" id="contact">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-lg mb-xl">
          <div className="md:col-span-1">
            ...
            <p className="text-sm text-on-surface-variant mb-6">{t("footer.tagline")}</p>
