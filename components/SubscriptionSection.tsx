    ...
    <section className="max-w-7xl mx-auto px-4 sm:px-6 py-xl" id="subscriptions">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-md">
        {subscriptionPlans.map((plan) => {
          const benefits = t.raw(`subscriptions.plans.${plan.id}.benefits`) as string[];
          return (
            <div
              key={plan.id}
            ...
            >
              ...
              <div className="flex items-baseline gap-2 mb-6">
                ...
                <span className={plan.highlight ? "text-white/80" : "text-on-surface-variant"}>
              ...
              <ul className="flex flex-col gap-3 mb-lg">
                {benefits.map((benefit) => (
                  ...
                  >
                    <Icon
                      name="check_circle"
                      className={plan.highlight ? "text-secondary-container" : "text-primary"}
                      filled
                    />
                    <span>{benefit}</span>
                  </li>
