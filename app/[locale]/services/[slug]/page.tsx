...
import { services, galleryImages } from "@/lib/mockData";
...
export async function generateMetadata({
  ...
  if (!service) return {};
  const t = await getTranslations({ locale, namespace: `services.${service.id}` });
  return {
    title: t("title"),
...
export default async function ServiceDetailPage({
  ...
  const features = t.raw("serviceFeatures") as ServiceFeatureT[];
