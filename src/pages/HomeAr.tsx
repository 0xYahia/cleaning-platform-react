      ...
      <section className="max-w-7xl mx-auto px-6 pb-xl">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link
              to="/ar/booking"
              className="bg-primary-container text-white px-10 py-4 rounded-full font-bold text-lg hover:shadow-lg active-scale transition-all"
            >
              احجز الآن
            </Link>
            <a
              href="#services"
              className="border-2 border-primary-container text-primary-container px-10 py-4 rounded-full font-bold text-lg hover:bg-primary-container/5 transition-all"
            >
              تعرف على خدماتنا
            </a>
          </div>
